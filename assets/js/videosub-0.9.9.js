...
(function (w) {
  ...
  (function (a) {
    ...
    a.provide = h, a.require = g, j.prototype.forEach = function (a, b) {
      ...
      if (typeof a == "string") return (b || document)
        .querySelectorAll(a);
    ...
    ! function (b, c, d) {
      ...
      var c = window,
        ...
        H = function (a, b, d) {
          var e = b.__beanDel,
            f = function (f) {
              f = A(f || ((this[l] || this.document || this)
                  .parentWindow || c)
                .event, !0), e && (f.currentTarget = e.ft(f[m], a));
        ...
        I = function (a, b, d, e, f, g) {
          var h = b.__beanDel,
            i = function (i) {
              ...
              if (e ? e.apply(j, arguments) : q ? !0 : i && i.propertyName === "_on" + d || !i) i && (i = A(i || ((this[l] || this.document || this)
                  .parentWindow || c)
                .event, g), i.currentTarget = j), b.apply(a, i && (!f || f.length === 0) ? arguments : s.call(arguments, i ? 0 : 1)
                .concat(f))
            };
          i.__beanDel = h;
          return i
        ...
        O = function (a, b, c, d, e) {
          ...
          if (b && !c && typeof b == "object")
            ...
            i = arguments.length > 3 ? s.call(arguments, 3) : [], g = (k ? c : b)
              .split(" "), k && (c = M(b, j = d, e || E)) && (i = s.call(i, 1)), this === x && (c = J(N, a, b, c, j));
    ...
    (function (b, c, d) {
      ...
      function W(a, b) {
        ...
        if (a.$ && typeof a.cloneEvents == "function") {
          a.$(c)
            ...
            .find("*"), e = a.$(b)
            .find("*");
          for (var f = 0; f < e.length; f++) a.$(d[f])
            .cloneEvents(e[f])
        }
        return c
      }
      ...
      function J(a) {
        return a ? a.replace(/([a-z])([A-Z])/g, "$1-$2")
          .toLowerCase() : a
      }
      ...
      var a = window,
        ...
        z = function () {
          ...
          return {
            ...
            opasity: function () {
              return typeof b.createElement("a")
      ...
      z.classList ? (o = function (a, b) {
        ...
        html: function (a, b) {
          ...
          return typeof a != "undefined" ? this.empty()
            .each(h) : this[0] ? this[0][d] : ""
        },
        text: function (a) {
    ...
    (function (b, c, d) {
      ...
      function Q(a, b) {
        ...
        k = (r = r.slice(0))
          .pop(), r.length && (j = r[r.length - 1].match(l)) && (q = X(b, j[1]));
        if (!q) return c;
    ...
    $VIDEOSUB('video')
      .each(function (el) {
        ...
        if (subtitlesrc.indexOf('.srt') != -1) { // we have a track tag and it's a .srt file
          ...
          $VIDEOSUB(el)
            .addListener('timeupdate', function (an_event) {
              var subtitle = '';
