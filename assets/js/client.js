...
(function () {
    ...
    if (typeof gapiIsLoaded !== 'function') throw new Error('gapiIsLoaded callback function must be defined prior to ' + 'loading gapi-chrome-apps.js');
    ...
    gapi.auth.authorize = function (params, callback) {
        ...
        var callbackWrapper = function (getAuthTokenCallbackParam) {
            ...
            if (typeof access_token !== 'undefined') callback({
